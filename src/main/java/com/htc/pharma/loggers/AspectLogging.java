package com.htc.pharma.loggers;
...
public class AspectLogging {
	@Before("execution(* com.htc.pharma.dao.PharmaDaoImplementation.*(..))")
	...
	@AfterReturning(pointcut="execution(* com.htc.pharma.dao.PharmaDaoImplementation.*(..))", returning="retVal")
	...
	@AfterThrowing(pointcut="execution(* com.htc.pharma.dao.PharmaDaoImplementation.*(..))", throwing="ex")
